...
<div style="text-align:center;">
  <a href="http://sc25.supercomputing.org"><img height=100 src="img/sc25_logo_head3.svg" /></a>
  &nbsp;  &nbsp;  &nbsp;  &nbsp;
  <a href="https://www.vi-hps.org/"><img height=100 src="img/Logo_vihps.png" /></a>
</div>

Held in conjunction with SC25: The International Conference on High Performance Computing, Networking, Storage and Analysis, and supported by the Virtual Institute - High Productivity Supercomputing (VI-HPS).
{: style="text-align: center"}

**When:** November 17, 2025, afternoon (TBA: exact times)

**Where:** America's Center Convention Complex, St. Louis, MO, USA (TBA: Room)
...
* [ProTools 24 (Atlanta, GA, USA)](https://sc-protools-workshop.github.io/protools24/)
